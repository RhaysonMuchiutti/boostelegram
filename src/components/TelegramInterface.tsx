...
export const TelegramInterface = () => {
  ...
  return (
    <div className="flex h-full w-full bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden relative max-h-full">
